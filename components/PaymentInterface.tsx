  ...
  return (
    <div className="bg-white rounded-lg shadow-lg p-6 max-w-2xl mx-auto">
      ...
      <div className="bg-gray-50 rounded-lg p-4 mb-6">
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <span className="text-gray-600">Session ({booking.duration} minutes)</span>
      ...
      {paymentMethod === 'wallet' && (
        <div className="bg-green-50 rounded-lg p-4 mb-6">
          <p className="text-green-800 text-sm">
            Pay using your digital wallet. Supported: Apple Pay, Google Pay, PayPal.
          </p>
        </div>
      )}
      ...
      <p className="text-xs text-gray-500 mt-4 text-center">
        ...
        Payments are processed securely through our certified payment partners.
      </p>
    </div>
  );
};
