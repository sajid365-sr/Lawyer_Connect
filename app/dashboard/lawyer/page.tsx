...
import { LawyerDashboardData, Booking, Review, TimeSlot } from '@/types';
import { 
  CalendarDaysIcon, 
  CurrencyDollarIcon, 
  UsersIcon,
...
const LawyerDashboard: React.FC = () => {
  const [activeTab, setActiveTab] = useState<'overview' | 'bookings' | 'schedule' | 'earnings' | 'reviews'>('overview');
  const [selectedDate, setSelectedDate] = useState(new Date());

  // Mock data
  const dashboardData: LawyerDashboardData = {
    upcomingBookings: [
      {
        id: '1',
        clientId: 'client1',
      ...
      <div className="bg-white shadow-sm border-b">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="py-6">
            ...
            <p className="text-gray-600 mt-2">Manage your practice and client appointments</p>
          </div>
        </div>
      </div>
          ...
          <div className="bg-white rounded-lg shadow p-6">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                ...
                <p className="text-2xl font-bold text-gray-900">{dashboardData.todayBookings.length}</p>
              </div>
            </div>
          </div>
          ...
          <div className="p-6">
                          ...
                          <div key={booking.id} className="border rounded-lg p-4">
                            <div className="flex justify-between items-start">
                              <div className="flex-1">
                                ...
                                <h4 className="font-medium text-gray-900">{booking.type.charAt(0).toUpperCase() + booking.type.slice(1)}</h4>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="font-medium text-gray-900 mb-3">Earnings Trend</h4>
                    ...
                    <div className="bg-gray-50 rounded-lg p-4">
                      <h4 className="font-medium text-gray-900 mb-3">Client Growth</h4>
                      <ResponsiveContainer width="100%" height={200}>
            ...
            {activeTab === 'bookings' && (
              <div className="space-y-6">
                ...
                <div className="space-y-4">
                  {[...dashboardData.todayBookings, ...dashboardData.upcomingBookings].map((booking) => (
                    <div key={booking.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start">
                        <div className="flex-1">
                          <div className="flex items-center space-x-2 mb-2">
                          ...
                          <h4 className="font-medium text-gray-900">{booking.notes}</h4>
                          <p className="text-sm text-gray-500 mt-1">
                            {format(new Date(booking.date), 'MMMM d, yyyy')} at {booking.time} ({booking.duration} min)
                          </p>
                          <p className="text-sm font-medium text-gray-900 mt-2">
                            ${booking.totalAmount} - {booking.paymentStatus === 'paid' ? 'Paid' : 'Pending Payment'}
                          </p>
                        </div>
                        <div className="flex space-x-2">
            ...
            {activeTab === 'schedule' && (
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                        ...
                        <div key={slot.id} className="flex items-center justify-between p-3 border rounded-lg">
                          ...
                          <div className="flex space-x-2">
                            <span className={`px-2 py-1 rounded-full text-xs font-medium ${
                              slot.isBooked ? 'text-red-600 bg-red-100' : 'text-green-600 bg-green-100'
                            }`}>
                  ...
                  <div>
                    <h4 className="font-medium text-gray-900 mb-4">Weekly Overview</h4>
                    <div className="bg-gray-50 rounded-lg p-4">
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
                    <div className="bg-green-50 rounded-lg p-4">
                      ...
                      <p className="text-2xl font-bold text-green-900">${dashboardData.monthlyEarnings.toLocaleString()}</p>
                      <p className="text-sm text-green-600">+12% from last month</p>
                    </div>
                    <div className="bg-blue-50 rounded-lg p-4">
                      <h4 className="font-medium text-blue-900">Pending Payouts</h4>
                      <p className="text-2xl font-bold text-blue-900">$1,250</p>
                      <p className="text-sm text-blue-600">Available in 3 days</p>
                    </div>
                    <div className="bg-purple-50 rounded-lg p-4">
                      <h4 className="font-medium text-purple-900">Total Earned</h4>
                      <p className="text-2xl font-bold text-purple-900">$28,450</p>
                      <p className="text-sm text-purple-600">Since joining</p>
                    </div>
                  </div>

                  <div className="bg-white border rounded-lg p-6">
                    <h4 className="font-medium text-gray-900 mb-4">Monthly Earnings Trend</h4>
                ...
                <div>
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-6">
                    <div className="bg-yellow-50 rounded-lg p-4 text-center">
                      ...
                      <p className="text-2xl font-bold text-yellow-900">{dashboardData.averageRating}</p>
